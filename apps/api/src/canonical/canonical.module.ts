...
@Module({ imports: [SupabaseModule, RbacModule], controllers: [CanonicalEntitiesController, CanonicalFieldsController, FieldMappingsController, RulesController], providers: [MappingService] })
