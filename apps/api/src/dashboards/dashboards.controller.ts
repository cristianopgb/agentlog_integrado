...
export class DashboardsController {
  ...
  @Post(':id/ai-realtime-session') @RequirePermission('dashboards.view') realtime(@Param('tenantId') tenantId:string,@Param('id') id:string,@Req() req:AuthenticatedRequest,@Body() body:Record<string,unknown>={}){return this.service.aiRealtimeSession(tenantId,id,req.user.id,body);}
  @Post(':id/ai-speech') @RequirePermission('dashboards.view') speech(@Param('tenantId') tenantId:string,@Param('id') id:string,@Req() req:AuthenticatedRequest,@Body() body:Record<string,unknown>={}){return this.service.aiSpeech(tenantId,id,req.user.id,body);}
