...
export type DashboardIndicator={id:string;source:'native'|'custom';name:string;family_key?:string|null;family_label?:string|null;result_shape:'scalar'|'table'|'matrix'|'distribution'|'ranking'|'timeseries'|'empty';allowed_visual_types:VisualType[];recommended_visual_type:VisualType;compatibility_reason:string};
