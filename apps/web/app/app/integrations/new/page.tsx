...
const options = [
  ...
  { type: 'api', title: 'API', description: 'Puxe dados do legado com conexão segura, pareamento nativo e sincronização controlada.' },
